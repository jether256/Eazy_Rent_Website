...
$final_path5=$path1.$house_5;
    ...
    values('$id','$own','$phon','$biz','$num','$mail','$final_path1','$final_path2','$final_path3','$final_path4','$final_path5','$tit','$pr','$desc','$adu','$lat','$lon','$place','$bed','$bath','$fun','$conn','$bs','$cs','$fl','$kit','No','$cre','$cre','No','Bangalows','$path1')";
