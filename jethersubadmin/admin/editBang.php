...
if(isset($_POST['submit'])){
   ...
   $profile= new All($con);
   $profile->editBang($_POST['name'],$_POST['bed'],$_POST['bath'],$_POST['fun'],$_POST['cons'],
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="view_bang.php">View Bangalow</a></li>
              <li class="breadcrumb-item active">Edit Bangalow</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Bangalow</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
