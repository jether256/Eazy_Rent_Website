...
if(isset($_POST['submit'])){
   ...
   $profile= new All($con);
   $profile->addTour($_POST['name'],$_POST['bed'],$_POST['bath'],$_POST['fun'],$_POST['cons'],
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h1>Add Toursit B & B</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Add Toursit B & B</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Bangalow</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
